...
namespace Neko\Framework\Router;
...
class Router {
    ...
    public function url($routename)
    {
        ...
        {
            //return $app->config['app.base_url'].$app->router->findRouteByName($routename)->getPath();
            return $app->router->findRouteByName($routename)->getPath();
        }
    }
