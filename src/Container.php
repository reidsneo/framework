...
class Container implements ArrayAccess {
    ...
    public function resolveArguments(array $parameters, array $additional_args = array())
    {
        ...
        foreach($parameters as $i => $param) {
            ...
            //object(ReflectionClass)#65 (1) { ["name"]=> string(18) "Neko\Framework\App" } 
            $param_class = $param->getType() && !$param->getType()->isBuiltin() ? new ReflectionClass($param->getType()->getName()) : null;
