...
namespace Neko\Framework\Dotenv\Repository;

use Neko\Framework\Dotenv\Repository\Adapter\AdapterInterface;
use Neko\Framework\Dotenv\Repository\Adapter\EnvConstAdapter;
use Neko\Framework\Dotenv\Repository\Adapter\GuardedWriter;
use Neko\Framework\Dotenv\Repository\Adapter\ImmutableWriter;
use Neko\Framework\Dotenv\Repository\Adapter\MultiReader;
use Neko\Framework\Dotenv\Repository\Adapter\MultiWriter;
use Neko\Framework\Dotenv\Repository\Adapter\ReaderInterface;
use Neko\Framework\Dotenv\Repository\Adapter\ServerConstAdapter;
use Neko\Framework\Dotenv\Repository\Adapter\WriterInterface;
use InvalidArgumentException;
use Neko\Framework\Dotenv\Some;
use ReflectionClass;
...
final class RepositoryBuilder
{
     ...
     * @param \Neko\Env\Repository\Adapter\WriterInterface[] $writers
     ...
     *
     * @return \Neko\Env\Repository\RepositoryBuilder
     */
     ...
     *
     * @return \Generator<\Neko\Env\Repository\Adapter\AdapterInterface>
     */
     ...
     *
     * @param \Neko\Env\Repository\Adapter\ReaderInterface|string $reader
     *
     ...
     * the adapter is not supported, then we silently skip adding it.
     *
     * @param \Neko\Env\Repository\Adapter\WriterInterface|string $writer
     *
     * @throws \InvalidArgumentException
     *
     * @return \Neko\Env\Repository\RepositoryBuilder
     ...
     *
     * @param \Neko\Env\Repository\Adapter\WriterInterface|string $adapter
     *
     * @throws \InvalidArgumentException
     *
     * @return \Neko\Env\Repository\RepositoryBuilder
     ...
     *
     * @return \Neko\Env\Repository\RepositoryInterface
     */
