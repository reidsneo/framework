...
namespace Neko\Framework\Dotenv\Store\File;

use Neko\Framework\Dotenv\Exception\InvalidEncodingException;
...
final class Reader
{
     ...
     *
     * @throws \Neko\Framework\Dotenv\Exception\InvalidEncodingException
     *
