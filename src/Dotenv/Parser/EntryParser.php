...
use Neko\Framework\Dotenv\ResultType\Error;
...
final class EntryParser
{
     ...
     * @param string $line
     *
     * @return \Neko\Framework\Dotenv\ResultType\Result<array{string,string|null},string>
     */
    private static function splitStringIntoParts(string $line)
    {
        ...
        /** @var \Neko\Framework\Dotenv\ResultType\Result<array{string,string|null},string> */
     ...
     * @param string $name
     *
     * @return \Neko\Framework\Dotenv\ResultType\Result<string,string>
     */
     ...
     * @param string $value
     *
     * @return \Neko\Framework\Dotenv\ResultType\Result<\Neko\Framework\Dotenv\Parser\Value,string>
     */
     ...
     * @param string $token
     *
     * @return \Neko\Framework\Dotenv\ResultType\Result<array{string,bool,int},string>
     */
    private static function processToken(int $state, string $token)
    {
        switch ($state) {
            case self::INITIAL_STATE:
                if ($token === '\'') {
                    /** @var \Neko\Framework\Dotenv\ResultType\Result<array{string,bool,int},string> */
